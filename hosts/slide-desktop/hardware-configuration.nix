...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/c10a70d8-770a-4dcf-9b9a-405fc7a55680";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/F79D-E761";
      fsType = "vfat";
    };
  ...
  swapDevices =
    [ { device = "/dev/disk/by-uuid/9c7281bf-e380-48fe-b6b8-c3b88617541d"; }
    ];
